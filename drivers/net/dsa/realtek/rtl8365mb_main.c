...
#define  RTL8365MB_SDS_INDEX_MASK               GENMASK(6, 0)
...
/* Jam Table RTL8365MB-VC Registers */
...
static int rtl8365mb_ext_sgmii_nway(struct realtek_priv *priv, bool state)
{
	...
	return regmap_set_bits(priv->map, RTL8365MB_MISC_CFG0,
			       RTL8365MB_MISC_CFG0_DW8051_EN);
}
					 ...
					 const struct phylink_link_state *state)
{
	...
	if (phy_interface_mode_is_rgmii(state->interface)) {
		...
		rtl8365mb_ext_sgmii_nway(priv, phylink_autoneg_inband(mode));
	}
